...
void ConfigHandler::LoadConfig() {
    ...
    try {
        ...
        if (this->Widget.General.font >= fontVec.size()) {
            this->Widget.General.font = 0;
        }
        ...
        this->Widget.General.autoResolutionScale = tbl["Widget"]["general_auto_resolution_scale"].value_or<bool>(true);
        this->Widget.General.showEmptySlots = tbl["Widget"]["general_show_empty_slots"].value_or<bool>(true);
        this->Widget.General.hudDiamondEnable = tbl["Widget"]["general_hud_diamond_enable"].value_or<bool>(true);
        this->Widget.General.hudDiamondLeftEnable = tbl["Widget"]["general_hud_diamond_left_enable"].value_or<bool>(true);
        this->Widget.General.hudArmorEnable = tbl["Widget"]["general_hud_armor_enable"].value_or<bool>(true);
        this->Widget.General.hudArmorAutoStack = tbl["Widget"]["general_hud_armor_auto_stack"].value_or<bool>(true);

        this->Widget.Equipset.Normal.bgType = tbl["Widget"]["normal_background"].value_or<std::string>("_BACKGROUND4");
        this->Widget.Equipset.Normal.bgSize = tbl["Widget"]["normal_background_size"].value_or<uint32_t>(63);
        this->Widget.Equipset.Normal.bgAlpha = tbl["Widget"]["normal_background_alpha"].value_or<uint32_t>(100);
        this->Widget.Equipset.Normal.widgetSize = tbl["Widget"]["normal_widget_size"].value_or<uint32_t>(24);
        this->Widget.Equipset.Normal.fontSize = tbl["Widget"]["normal_font_size"].value_or<uint32_t>(55);
        this->Widget.Equipset.Normal.fontShadow = tbl["Widget"]["normal_font_shadow"].value_or<bool>(true);

        this->Widget.Equipset.Potion.bgType = tbl["Widget"]["potion_background"].value_or<std::string>("_BACKGROUND4");
        this->Widget.Equipset.Potion.bgSize = tbl["Widget"]["potion_background_size"].value_or<uint32_t>(63);
        this->Widget.Equipset.Potion.bgAlpha = tbl["Widget"]["potion_background_alpha"].value_or<uint32_t>(100);
        this->Widget.Equipset.Potion.widgetSize = tbl["Widget"]["potion_widget_size"].value_or<uint32_t>(24);
        this->Widget.Equipset.Potion.fontSize = tbl["Widget"]["potion_font_size"].value_or<uint32_t>(55);
        this->Widget.Equipset.Potion.fontShadow = tbl["Widget"]["potion_font_shadow"].value_or<bool>(true);

        this->Widget.Equipset.Cycle.bgType = tbl["Widget"]["cycle_background"].value_or<std::string>("_BACKGROUND4");
        this->Widget.Equipset.Cycle.bgSize = tbl["Widget"]["cycle_background_size"].value_or<uint32_t>(63);
        this->Widget.Equipset.Cycle.bgAlpha = tbl["Widget"]["cycle_background_alpha"].value_or<uint32_t>(100);
        this->Widget.Equipset.Cycle.widgetSize = tbl["Widget"]["cycle_widget_size"].value_or<uint32_t>(24);
        this->Widget.Equipset.Cycle.fontSize = tbl["Widget"]["cycle_font_size"].value_or<uint32_t>(55);
        this->Widget.Equipset.Cycle.fontShadow = tbl["Widget"]["cycle_font_shadow"].value_or<bool>(true);

        this->Widget.Equipment.Armor.bgType = tbl["Widget"]["armor_background"].value_or<std::string>("_NONE");
        this->Widget.Equipment.Armor.bgSize = tbl["Widget"]["armor_background_size"].value_or<uint32_t>(24);
        this->Widget.Equipment.Armor.bgAlpha = tbl["Widget"]["armor_background_alpha"].value_or<uint32_t>(0);
        this->Widget.Equipment.Armor.widgetSize = tbl["Widget"]["armor_widget_size"].value_or<uint32_t>(20);
        this->Widget.Equipment.Armor.fontSize = tbl["Widget"]["armor_font_size"].value_or<uint32_t>(50);
        this->Widget.Equipment.Armor.fontShadow = tbl["Widget"]["armor_font_shadow"].value_or<bool>(true);

        this->Widget.Equipment.Weapon.bgType = tbl["Widget"]["weapon_background"].value_or<std::string>("_BACKGROUND4");
        this->Widget.Equipment.Weapon.bgSize = tbl["Widget"]["weapon_background_size"].value_or<uint32_t>(63);
        this->Widget.Equipment.Weapon.bgAlpha = tbl["Widget"]["weapon_background_alpha"].value_or<uint32_t>(100);
        this->Widget.Equipment.Weapon.widgetSize = tbl["Widget"]["weapon_widget_size"].value_or<uint32_t>(24);
        this->Widget.Equipment.Weapon.fontSize = tbl["Widget"]["weapon_font_size"].value_or<uint32_t>(55);
        this->Widget.Equipment.Weapon.fontShadow = tbl["Widget"]["weapon_font_shadow"].value_or<bool>(true);

        this->Widget.Equipment.Shout.bgType = tbl["Widget"]["shout_background"].value_or<std::string>("_BACKGROUND4");
        this->Widget.Equipment.Shout.bgSize = tbl["Widget"]["shout_background_size"].value_or<uint32_t>(63);
        this->Widget.Equipment.Shout.bgAlpha = tbl["Widget"]["shout_background_alpha"].value_or<uint32_t>(100);
        this->Widget.Equipment.Shout.widgetSize = tbl["Widget"]["shout_widget_size"].value_or<uint32_t>(24);
        this->Widget.Equipment.Shout.fontSize = tbl["Widget"]["shout_font_size"].value_or<uint32_t>(55);
...
void ConfigHandler::SaveConfig() {
    ...
    auto tbl = toml::table{
        {"Widget", toml::table{
                ...
                {"general_auto_resolution_scale", this->Widget.General.autoResolutionScale},
                {"general_show_empty_slots", this->Widget.General.showEmptySlots},
                {"general_hud_diamond_enable", this->Widget.General.hudDiamondEnable},
                {"general_hud_diamond_left_enable", this->Widget.General.hudDiamondLeftEnable},
                {"general_hud_armor_enable", this->Widget.General.hudArmorEnable},
                {"general_hud_armor_auto_stack", this->Widget.General.hudArmorAutoStack},
